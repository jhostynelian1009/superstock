        ...
        <form action="{{ route('admin.categorias.index') }}" method="GET" class="flex w-full max-w-md items-center gap-2">
            <div class="relative flex-1">
                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Buscar por nombre..."
                    class="w-full rounded-sm border border-[#e3e3e0] bg-white pl-10 pr-4 py-2 text-sm text-[#1b1b18] focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20 dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC]">
        ...
        <div class="rounded-lg border border-[#e3e3e0] bg-white p-12 text-center dark:border-[#3E3E3A] dark:bg-[#161615]">
            @if (filled($search))
                <div class="flex flex-col items-center justify-center">
                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 dark:bg-slate-900/60 text-brand-primary dark:bg-slate-900/50 dark:text-[#FF4433] mb-4">
            ...
            @else
                <div class="flex flex-col items-center justify-center">
                    ...
                    <a href="{{ route('admin.categorias.create') }}"
                        class="inline-flex items-center justify-center rounded-sm bg-brand-primary px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-primary-hover">
                        Registrar categoría
                    </a>
                </div>
            @endif
