        ...
        <form action="{{ route('admin.productos.update', $product) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                    class="min-h-[120px] w-full resize-y rounded-sm border border-[#e3e3e0] bg-white px-4 py-3 text-sm focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20 dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC]">{{ old('description', $product->description) }}</textarea>
            </div>
